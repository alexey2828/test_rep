...
const cardContainer: ViewStyle = {
  marginTop: 0, margin: 10, backgroundColor: '#242424', borderRadius: 10
}
...
const stateItem: TextStyle = {
  color: '#a1a1a1', marginLeft: 10, fontSize: 14,
}
...
const ScreenContainer: TextStyle = {
  backgroundColor: '#121212', height: 800
}
